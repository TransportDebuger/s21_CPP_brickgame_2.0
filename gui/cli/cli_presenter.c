...
void printBoardLayout() {
  ...
  printFrame(4, 1, 10, 10, HINTS_LABEL);
  // Main board
  ...
  printFrame(16, 45, 7, 10, GAME_STATUS_LABEL);
}
...
void printPauseMsg() { mvprintw(3, 5, "\"P A U S E\""); }
...
void printGameBoard() { printGameField(NULL, 0); }
